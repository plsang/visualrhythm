...
count=0
for f in `ls /net/per900a/raid0/plsang/dataset/MED11_Resized/MED11DEV/*.mp4`
do 
	if [ "$count" -ge $1 ] && [ "$count" -lt $2 ]; then
		...
		./visualrhythm 80 0 0 /net/per900a/raid0/plsang/dataset/MED11_Resized/MED11DEV $fn /net/per900a/raid0/plsang/dataset/MED11_Resized/sbd/devel/$of
	fi
	let count=$count+1;
